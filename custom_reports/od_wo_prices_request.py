...
def get_od_wo_prices_data(promo_id, user_name, limit):
    ...
    for promos in promo_id:
        ...
        select_promos_query  = open("custom_reports/od_wo_prices_query.sql", encoding='utf-8', mode="r").read()
        ...
        def count_values(pivoted_df, value):
            ...
            """
            return pivoted_df.groupby(['promo_id', 'Регион проведения акции', 'Торговая марка'])['Модуль'].transform(lambda x: x.eq(str(value)).sum())
